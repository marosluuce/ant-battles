...
var _user$project$World$pointDecoder = A3(
	...
	_elm_lang$core$Json_Decode$float);
var _user$project$World$empty = {
	ants: _elm_lang$core$Native_List.fromArray(
		[]),
	food: _elm_lang$core$Native_List.fromArray(
		[]),
	nests: _elm_lang$core$Native_List.fromArray(
		[])
};
var _user$project$World$Nest = F5(
	function (a, b, c, d, e) {
		return {id: a, position: b, team: c, ants: d, food: e};
	});
var _user$project$World$nestDecoder = A6(
	_elm_lang$core$Json_Decode$object5,
	_user$project$World$Nest,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'location', _user$project$World$pointDecoder),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'team', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'ants', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'food', _elm_lang$core$Json_Decode$int));
var _user$project$World$Ant = F4(
	function (a, b, c, d) {
		return {position: a, team: b, hasFood: c, nestId: d};
	});
var _user$project$World$antDecoder = A5(
	_elm_lang$core$Json_Decode$object4,
	_user$project$World$Ant,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'location', _user$project$World$pointDecoder),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'team', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'got_food', _elm_lang$core$Json_Decode$bool),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'nest', _elm_lang$core$Json_Decode$int));
var _user$project$World$World = F3(
	function (a, b, c) {
		return {ants: a, food: b, nests: c};
	});
var _user$project$World$worldDecoder = A4(
	_elm_lang$core$Json_Decode$object3,
	_user$project$World$World,
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'ants',
		_elm_lang$core$Json_Decode$list(_user$project$World$antDecoder)),
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'food',
		_elm_lang$core$Json_Decode$list(_user$project$World$pointDecoder)),
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'nests',
		_elm_lang$core$Json_Decode$list(_user$project$World$nestDecoder)));
var _user$project$World$parse = function (string) {
	return A2(_elm_lang$core$Json_Decode$decodeString, _user$project$World$worldDecoder, string);
};

var _user$project$Util$randomColor = function (nestId) {
	var seed = _elm_lang$core$Random$initialSeed(nestId);
	var _p0 = A2(
		_elm_lang$core$Random$step,
	...
	var _p3 = A2(
		_elm_lang$core$Random$step,
		A2(_elm_lang$core$Random$float, 0.5, 1),
		seed3);
	var a = _p3._0;
	return A4(_elm_lang$core$Color$rgba, r, g, b, a);
};

var _user$project$Arena$box = F3(
	function (scale, _p0, color) {
		var _p1 = _p0;
		return A2(
			_evancz$elm_graphics$Collage$move,
			{ctor: '_Tuple2', _0: _p1._0 * scale, _1: _p1._1 * scale},
			A2(
				_evancz$elm_graphics$Collage$filled,
				color,
				_evancz$elm_graphics$Collage$square(scale)));
	});
var _user$project$Arena$scaledText = F3(
	function (string, scale, _p2) {
		var _p3 = _p2;
		var displayed = _evancz$elm_graphics$Text$fromString(string);
		var position = {ctor: '_Tuple2', _0: _p3._0 * scale, _1: (_p3._1 * scale) + (scale / 8)};
		return A2(
			_evancz$elm_graphics$Collage$move,
			position,
...
var _user$project$Arena$renderFood = F2(
	function (scale, _p4) {
		var _p5 = _p4;
		var sideLength = scale / 2;
		return A2(
			_evancz$elm_graphics$Collage$move,
			{ctor: '_Tuple2', _0: _p5._0 * scale, _1: _p5._1 * scale},
			A2(
				_evancz$elm_graphics$Collage$filled,
				_elm_lang$core$Color$lightBrown,
				A2(_evancz$elm_graphics$Collage$ngon, 6, sideLength)));
	});
var _user$project$Arena$renderAnt = F2(
	function (scale, ant) {
		var renderedName = A3(_user$project$Arena$scaledText, 'F', scale, ant.position);
		var antColor = _user$project$Util$randomColor(ant.nestId);
		var renderedAnt = A3(_user$project$Arena$box, scale, ant.position, antColor);
		return ant.hasFood ? _evancz$elm_graphics$Collage$group(
			_elm_lang$core$Native_List.fromArray(
				[renderedAnt, renderedName])) : renderedAnt;
	});
var _user$project$Arena$background = F3(
	function (blocksWide, blocksHigh, scale) {
		var height = blocksHigh * scale;
		var width = blocksWide * scale;
		return A2(
			_evancz$elm_graphics$Collage$filled,
			_elm_lang$core$Color$lightGrey,
			A2(_evancz$elm_graphics$Collage$rect, width, height));
	});
var _user$project$Arena$scale = 20;
var _user$project$Arena$render = F2(
	function (_p7, _p6) {
		var _p8 = _p7;
		var _p9 = _p6;
		var renderedHive = A3(
			_user$project$Arena$box,
			_user$project$Arena$scale,
			{ctor: '_Tuple2', _0: 0, _1: 0},
			_elm_lang$core$Color$black);
		var renderedFood = A2(
			_elm_lang$core$List$map,
			_user$project$Arena$renderFood(_user$project$Arena$scale),
			_p9.food);
		var renderedAnts = A2(
			_elm_lang$core$List$map,
			_user$project$Arena$renderAnt(_user$project$Arena$scale),
			_p9.ants);
		var renderedBg = A3(_user$project$Arena$background, 51, 51, _user$project$Arena$scale);
		var elements = A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Native_List.fromArray(
				[renderedBg]),
		...
		return _evancz$elm_graphics$Element$toHtml(
			A3(_evancz$elm_graphics$Collage$collage, _p8._0, _p8._1, elements));
	});
var _user$project$Arena$renderColorSquare = function (_p10) {
	var _p11 = _p10;
	var nestColor = _user$project$Util$randomColor(_p11.id);
	var colorSquare = A2(
		_evancz$elm_graphics$Collage$filled,
		nestColor,
		_evancz$elm_graphics$Collage$square(_user$project$Arena$scale));
	return _evancz$elm_graphics$Element$toHtml(
		A3(
...
var _user$project$Main$parseResponse = function (message) {
	return A2(
		_elm_lang$core$Result$withDefault,
		_user$project$World$empty,
		_user$project$World$parse(message));
};
var _user$project$Main$nestRow = function (nest) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Arena$renderColorSquare(nest)
					])),
				A2(
				_elm_lang$html$Html$td,
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								{ctor: '_Tuple2', _0: 'maxWidth', _1: '100px'},
								{ctor: '_Tuple2', _0: 'overflow', _1: 'hidden'},
								{ctor: '_Tuple2', _0: 'textOverflow', _1: 'ellipsis'}
							]))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(nest.team)
					])),
				A2(
				_elm_lang$html$Html$td,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Basics$toString(nest.ants))
					])),
				A2(
				_elm_lang$html$Html$td,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						_elm_lang$core$Basics$toString(nest.food))
					]))
			]));
};
var _user$project$Main$nestBox = function (nests) {
	var header = A2(
		_elm_lang$html$Html$tr,
		_elm_lang$core$Native_List.fromArray(
			[]),
	...
	var sortedNests = A2(
		...
		nests);
	var rows = A2(_elm_lang$core$List$map, _user$project$Main$nestRow, sortedNests);
	var tableBody = A2(_elm_lang$core$List_ops['::'], header, rows);
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Nests')
					])),
				A2(
...
var _user$project$Main$header = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html$text('Welcome to the 🐜💨 Battle Zone™')
		]));
var _user$project$Main$view = function (_p0) {
	var _p1 = _p0;
	var _p2 = _p1.world;
	var nests = _user$project$Main$nestBox(_p2.nests);
	var arena = A2(
		_user$project$Arena$render,
		{ctor: '_Tuple2', _0: 1040, _1: 1040},
		_p2);
	var elements = _elm_lang$core$Native_List.fromArray(
		[_user$project$Main$header, nests, arena]);
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
...
var _user$project$Main$websocketUrl = function (hostname) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'ws://',
		A2(_elm_lang$core$Basics_ops['++'], hostname, ':4000/ws'));
};
var _user$project$Main$update = F2(
	function (action, model) {
		var _p3 = action;
		var world = _user$project$Main$parseResponse(_p3._0);
		return {
			ctor: '_Tuple2',
...
var _user$project$Main$init = function (_p4) {
	...
	return {
		ctor: '_Tuple2',
		_0: {world: _user$project$World$empty, location: _p5.location},
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
...
var _user$project$Main$subscriptions = function (_p6) {
	var _p7 = _p6;
	var url = _user$project$Main$websocketUrl(_p7.location);
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_elm_lang$websocket$WebSocket$listen, url, _user$project$Main$Response)
			]));
};
